...
var DocumentSemanticTokensProvider = class {
  ...
  static {
    this.legend = new vscode3.SemanticTokensLegend(["keyword"]);
  }
...
var VariableNamesSourceAction = class _VariableNamesSourceAction {
  constructor(container) {
    this.container = container;
  }
  static {
    this.kind = vscode3.CodeActionKind.Notebook.append("source.normalizeVariableNames");
  }
  provideCodeActions(document, _range, _context) {
    const project = this.container.lookupProject(document.uri);
